from prazo.config import CONCESSIONARIAS, PASTA_SAIDA
from prazo.carregamento import carregar_dados
from prazo.filtros import filtrar_periodo, excluir_invalidos
from prazo.medidas import calcular_dias_exec, criar_status_prazo, criar_prazo_dict, calcular_prazo_dax
from prazo.top10 import gerar_top10
from prazo.top3 import gerar_top3
from prazo.grafico import gerar_grafico
import pandas as pd
import matplotlib.pyplot as plt
from prazo.tabela import salvar_tabela_img
from prazo.card import gerar_cards_os
...
def main():
    ...
    for conc in CONCESSIONARIAS:
        ...
        # Gerar cards
        gerar_cards_os(df_mes, conc, f"{PASTA_SAIDA}/{conc}_Prazo_Cards")
    ...
    for conc in CONCESSIONARIAS:
        ...
        salvar_tabela_img(top10, f"{PASTA_SAIDA}/{conc}_Prazo_Top10")
    ...
    for conc in CONCESSIONARIAS:
        ...
        salvar_tabela_img(top3, f"{PASTA_SAIDA}/{conc}_Prazo_Top3")
